...
3. Once the installation is complete, you can find cosmos-monitor in your Start Menu.

### macOS Installation
1. Open the downloaded .dmg file.
2. Drag the cosmos-monitor icon into your Applications folder.
3. Launch the app from your Applications folder or Spotlight Search.

### Linux Installation
1. Open a terminal window.
2. Navigate to the folder where you downloaded the file.
3. Use the following command to install (replace `package_name` with the actual filename):
   ```bash
   sudo dpkg -i package_name
   ```
4. Launch cosmos-monitor from your applications or terminal.

## 🔍 Features
- **User-Friendly Interface:** Simple design for easy navigation.
- **Real-time Monitoring:** See updates and notifications instantly.
- **Data Visualization:** Visual charts for better understanding of data.

## 📈 How to Use
After installing, follow these steps to get started:

1. Open the application.
2. Set up your monitoring preferences.
3. Add the tasks or processes you want to monitor.
